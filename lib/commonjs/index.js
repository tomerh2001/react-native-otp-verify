...
function getNativeEventEmitterModule() {
  const nativeModule = _reactNative.NativeModules.OtpVerify !== null && _reactNative.NativeModules.OtpVerify !== void 0 ? _reactNative.NativeModules.OtpVerify : {};
...
const eventEmitter = new _reactNative.NativeEventEmitter(getNativeEventEmitterModule());
